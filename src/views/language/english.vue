<template>
    ...
    <v-container class="my-4">
        <v-row>
            <v-col cols="12">
                <v-img src="../../assets/phonics.jpg" class="my-4" contain height="220" />
            </v-col>
        </v-row>
                                ...
                                <li class="body-1">
                                    <v-row align="center">
                                        <v-col cols="12" md="2" class="pr-md-2">
                                            <v-img src="../../assets/peteCat.jpg" contain height="300"/>
                                        </v-col>
                                        <v-col cols="12" md="6" class="pl-md-2">
                                            <p>This engaging box set includes 12 small books that focus on different phonics sounds. The stories are silly and fun, and the illustrations are colorful and eye-catching. Children will love following Pete the Cat on his adventures as they learn to sound out words.
                                             <a href="https://www.amazon.com/Pete-Childrens-Books-Phonics-Learn/dp/B0768YV2Y7" target="_blank">Pete the Cat Phonics Amazon book</a></p>
                                        </v-col>
                                    </v-row>
                                </li>
                                <li class="body-1">
                                    <v-row align="center">
                                        <v-col cols="12" md="2" class="pr-md-2">
                                            <v-img src="../../assets/fatCatMat.jpg" contain height="300"/>
                                        </v-col>
                                        <v-col cols="12" md="6" class="pl-md-2">
                                            ...
                                            <a href="https://www.amazon.com/other-tales-Phonics-Readers-Collection/dp/1409509230" target="_blank">Fat cat on a mat and other tales Amazon book</a></p>
                                        </v-col>
                                    </v-row>                                
                                </li>
    ...
    <v-container class="my-4">
        <v-row>
            <v-col cols="12">
                <v-img src="../../assets/readingfun.jpg" class="my-4" contain height="260" />
            </v-col>
        </v-row>
                ...
                <div>
                    ...
                    <ul style="list-style: none;">
                                <li class="body-1">
                                    <v-row align="center">
                                        <v-col cols="12" md="2" class="pr-md-2">
                                            <v-img src="../../assets/catinHat.jpg" contain height="300"/>
                                        </v-col>
                                        <v-col cols="12" md="6" class="pl-md-2">
                                            <p>This is a classic picture book by Dr. Seuss, this silly story features the rambunctious Cat in the Hat and his chaotic visit to two young children on a rainy day.
                                             <a href="https://www.amazon.com/Cat-Hat-Dr-Seuss/dp/039480001X" target="_blank">The Cat in the Hat Amazon book</a></p>
                                        </v-col>
                                    </v-row>
                                </li>
                                <li class="body-1">
                                    <v-row align="center">
                                        <v-col cols="12" md="2" class="pr-md-2">
                                            <v-img src="../../assets/charlotteWeb.jpg" contain height="300"/>
                                        </v-col>
                                        <v-col cols="12" md="6" class="pl-md-2">
                                            ...
                                            <a href="https://www.amazon.com/Charlottes-Web-Read-Aloud-White/dp/0060882611" target="_blank">Charlotte's Web Amazon book</a></p>
                                        </v-col>
                                    </v-row>                                
                                </li>
                            </ul>
    ...
    <v-container class="my-4">
        <v-row>
            <v-col cols="12">
                <v-img src="../../assets/hogwarts.jpg" class="my-4" contain height="320" />
            </v-col>
        </v-row>
                ...
                <div>
                    ...
                    <ul style="list-style: none;">
                                <li class="body-1">
                                    <v-row align="center">
                                        <v-col cols="12" md="2" class="pr-md-2">
                                            <v-img src="../../assets/sorceresStone.jpg" contain height="300"/>
                                        </v-col>
                                        <v-col cols="12" md="6" class="pl-md-2">
                                            <p>Eleven-year-old Harry Potter learns on his eleventh birthday that he's the orphaned son of two powerful wizards and possesses unique magical powers of his own. He is summoned from his life as an unwanted child by his parents' friend Albus Dumbledore, a powerful sorcerer and headmaster of Hogwarts School of Witchcraft and Wizardry.
                                             <a href="https://www.amazon.com/gp/product/0590353403" target="_blank">The Sorcerer's Stone Amazon book</a></p>
                                        </v-col>
                                    </v-row>
                                </li>
                                <li class="body-1">
                                    <v-row align="center">
                                        <v-col cols="12" md="2" class="pr-md-2">
                                            <v-img src="../../assets/deathlyHallows.jpg" contain height="300"/>
                                        </v-col>
                                        <v-col cols="12" md="6" class="pl-md-2">
                                            <p>Harry, Ron, and Hermione go on a perilous mission to find and destroy Voldemort's Horcruxes, the source of his immortality. The fate of the wizarding world hangs in the balance as they face their ultimate battle.
                                            <a href="https://www.amazon.com/Harry-Potter-Deathly-Hallows-Book/dp/1338878980" target="_blank">The Deathly Hallows Amazon book</a></p>
                                        </v-col>
                                    </v-row>                                
                                </li>
                            </ul>
